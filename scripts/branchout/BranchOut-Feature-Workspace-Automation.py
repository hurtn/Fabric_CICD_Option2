    ...
    if token:
        ...
        if workspace_id:
            ...
            if WH_VIEWS_ON_LH == 'False': 
                ...
                logging.info("Connecting workspace to git has been deferred to post activity notebook so that warehouse dependencies in the lakehouse can be created ie. shortcuts or data")
        else:
